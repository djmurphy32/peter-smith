<template>
  <PortfolioContent
    ...
    :key="config.title"
    :body="config.body"
    :imported-images="config.images"
    :title="config.title"
    :footer="config.footer"
    :video-link="config.videoLink"
  />
</template>
...
const configs: PortfolioConfig[] = [
  ...
  {
    title: "Arena Homme+ 60",
    body: ["An Cat Dubh", "with Natasha Arnold"],
    images: import.meta.glob(
      "../assets/images/portfolio/AH60_AnCatDubh/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
  ...
  {
    title: "'W'Happen?",
    body: ["Cult of Mowalola"],
    videoLink:
      "https://player.vimeo.com/video/914040307?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
    images: import.meta.glob("../assets/images/portfolio/Pop_Mowalola/*.jpg", {
      eager: true,
    }) as GlobEagerImport,
  },
  {
    ...
    body: ["The Collections"],
    images: import.meta.glob(
      "../assets/images/portfolio/AH59_TheCollections/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
  },
  {
    ...
    images: import.meta.glob(
      "../assets/images/portfolio/AH58_CaliforniaBoys/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
  ...
  },
  {
    ...
    images: import.meta.glob(
      "../assets/images/portfolio/Pop_StellaRose/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
  },
  {
    ...
    body: ["Three"],
    images: import.meta.glob("../assets/images/portfolio/ID_Spring23/*.jpg", {
      eager: true,
    }) as GlobEagerImport,
  },
  {
    title: "i-D Magazine Fall 22",
    body: ["Jockstrap"],
    videoLink:
      "https://player.vimeo.com/video/913733822?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
    images: import.meta.glob("../assets/images/portfolio/ID_Fall22/*.jpg", {
      eager: true,
    }) as GlobEagerImport,
  },
  {
    ...
    footer: [
      "Words - James Brown",
      "Styling - Charlotte Rubenstein",
      "Grooming - James Duggan",
    ],
    images: import.meta.glob(
      "../assets/images/portfolio/AH57_KalvinPhillips/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
  },
  {
    ...
    images: import.meta.glob(
      "../assets/images/portfolio/Replica_Spring22/*.jpg",
      {
        eager: true,
      },
    ) as GlobEagerImport,
